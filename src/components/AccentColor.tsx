...
const AccentColor: FC = () => {
  ...
  return (
    <div className="relative flex">
      ...
      {isShow && (
        <div className="fixed md:absolute md:space-y-2 bottom-[61px] md:top-10 md:bottom-auto md:flex-col md:w-auto items-center md:rounded-md justify-around bg-gray-50 dark:bg-blue-gray-900 md:dark:bg-blue-gray-800 md:bg-gray-100 p-2 flex md:right-0 left-0 w-full">
