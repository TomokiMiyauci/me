...
const Posts: FC<PageProps<BlogPostsQuery>> = (a) => {
  ...
  return (
    <Layout originalPath={originalPath} currentPath={location.pathname}>
      ...
      <section className="-mx-4 p-2  md:p-8 -mt-4 mb-4 md:-mt-7 heropattern-morphingdiamonds-gray-200 dark:heropattern-morphingdiamonds-gray-700 flex flex-col justify-center items-center">
